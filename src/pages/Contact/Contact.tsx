...
const Contact: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* Map placeholder */}
      <section className="section section-cream contact-map-section">
        {/* Background Decorative Elements */}
        <div className="map-bg-decoration">
          <div className="map-glow-orb map-glow-orb--1"></div>
          <div className="map-glow-orb map-glow-orb--2"></div>
          <div className="map-glow-orb map-glow-orb--3"></div>
          <div className="map-sparkle map-sparkle--1">✦</div>
          <div className="map-sparkle map-sparkle--2">✦</div>
          <div className="map-sparkle map-sparkle--3">✦</div>
        </div>
        ...
        <div className="container relative z-10">
          ...
          <div className="contact-map">
            <div className="contact-map__frame">
              <iframe 
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3627.6005493429643!2d73.69800717536272!3d24.60297817809823!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3967e52cac4fc73b%3A0x65b42682a08d5a2b!2sSHAGUN%20The%20Bridal%20Collection!5e0!3m2!1sen!2sin!4v1775105735942!5m2!1sen!2sin" 
                width="100%" 
                height="450" 
                style={{ border: 0 }} 
                ...
                title="Shagun The Bridal Collection Location"
              ></iframe>
            </div>
          </div>
        </div>
